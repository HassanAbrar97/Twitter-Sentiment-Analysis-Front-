...
class Dashboard extends Component {
  ...
  getImpression = (data) => {
    ...
    for (let i = 0; i < data.length; i++) {
      impression =
        impression + data[i].user.followers_count + data[i].retweet_count;
    }
    return impression;
  };
  getFav = (data) => {
  ...
  render() {
    try {
      ...
      const timeDiffInSecs = Math.floor(
        (new Date(timeEnd).getTime() - new Date(timeStart).getTime()) / 1000
      );
      ...
      let data2 = {
        datasets: [
          {
            data: tweetsByType,
            backgroundColor: ['#467fcf', '#a55eea', '#fd9644'],
          },
        ],
        labels: ['Tweets', 'Re-tweets', 'Replies'],
      };
      return (
        <>
          <div
            className="header py-4"
            style={{ marginBottom: '10px', backgroundColor: '#000' }}
          >
            <div className="container">
              <div className="d-flex sm md">
                ...
                >
                  {' '}
                  Search Result for {this.state.o.q.toLocaleUpperCase()}
                </h1>
                ...
                <div className="col col-6 col-sm-4 col-lg-2">
                  <div className="card">
                    <div className="card-body p-3 text-center">
                      ...
                      <div className="h1 m-0">{timeString}</div>
                    </div>
                  </div>
                </div>
                <div className="col col-6 col-sm-4 col-lg-2">
                  ...
                  <div className="row row">
                    ...
                    <div className="col col-xl-12 col-lg-12 col-md-12 col-sm-12">
                      <button
                        ...
                        onClick={this.handleAffin}
                      >
                        {!this.state.AffinGenerate
                          ? 'Generate Affinity Graph'
                          : 'Close Affinity Graph'}
                      </button>
      ...
      window.alert('There is an issue with your request parameters Try again');
      this.props.onClick(true, '', '');
      return <h6></h6>;
    }
  }
